...
name: devops-docker
description: >-
  Provides comprehensive guidance on Docker best practices for Dockerfile
  construction, image optimization, security, and CI/CD deployment. Use when
  working with Dockerfile, docker-compose.yml, *.dockerfile, container
  orchestration, or DevOps configuration.
---
